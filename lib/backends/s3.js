...
function S3Backend() {
  ...
  if (
    !this.opts.credentials.aws.accessKeyId ||
    !this.opts.credentials.aws.secretAccessKey ||
    !this.opts.configuration.aws.bucket
  ) {
    throw new Error(
      'S3 backend requires "AWS_ACCESS_KEY_ID", "AWS_SECRET_ACCESS_KEY", and "AWS_BUCKET" options',
    )
  }
